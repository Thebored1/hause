...
// The five-milestone deep dive used on /process. Each step carries its own
// theme, so the sequence alternates between white, sand and dark cards.

export interface ProcessDeepStep {
  num: string;
  tag: string;
  title: string;
  subtitle: string;
...
export interface ProcessDeepDiveProps {
  eyebrow?: string;
  title?: string;
